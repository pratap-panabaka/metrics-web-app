            ...
            }
            {
                ...
                <div className='min-h bg-lite max-width'>
                    <div className='flex flex-col space-y-5 p-5'>
                        <div className='text-dark font-bold'>{fullData.length} Mutual Funds data fetched</div>
                                    ...
                                    <form onSubmit={(e) => {
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className='mx-2 remove-arrow text-center border bg-lite border-toolite text-dark h-8 outline-none focus:border-2 font-custom placeholder:font-custom'
                                                required
                                            />
                                            <label className='text-dark font-custom font-bold'>
                                                of {Math.ceil(fullData.length / nPerPage)} <span className='text-sm font-sans text-toolite'>(100 per page)</span>
                                            </label>
                                        </div>
                                    </form>
                                    <div className='text-dark font-bold'>Showing Funding companies from {(page - 1) * 100 + 1} to {(page * 100) > fullData.length ? fullData.length : page * 100}</div>
